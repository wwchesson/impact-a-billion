class RequestsController < ApplicationController
  ...
  private
    ...
    def request_params
      params.require(:request).permit(:name, :description, :image, :approved, :location, :category, :hours_requested, :user_id, :organizer_id, :frequency, :volunteers_needed, :denied)
    end
end
